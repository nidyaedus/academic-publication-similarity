...
Bu çalışma ile veri madenciliği dersinde öğrenilen teorik bilgiler pratiğe dönüştürülmüştür.
...
- Veri madenciliği dersinde öğrenilen teorik kavramlar uygulamaya aktarılmıştır.  
- REST API kullanım süreci deneyimlenmiştir.  
- JSON veri işleme pratiği kazanılmıştır.  
- Metin madenciliği ve doğal dil işleme adımları uygulanmıştır.  
- Vektör uzayı modeli ve benzerlik ölçütlerinin çalışma prensibi kavranmıştır.  
- Embedding tabanlı semantik temsil ile TF-IDF yaklaşımı karşılaştırılmıştır.  
...
The complete pipeline, including data collection, preprocessing, vectorization, and similarity computation, was implemented end-to-end.
...
- Observe system outputs through a simple interface  

Through this study, theoretical knowledge gained in the Data Mining course was translated into practice.
...
- Theoretical data mining concepts were applied in practice.  
- REST API usage was experienced in a real implementation.  
- JSON data processing skills were developed.  
